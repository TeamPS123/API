...
namespace API_DACN.Object.Get
{
    public class GetLikeAndComment
    {
        ...
        public GetLikeAndComment(int status, string notification, GetLike getlike, IEnumerable<GetComment> comments)
        {
            this.status = status;
        ...
        public GetLike Getlike { get => getlike; set => getlike = value; }
